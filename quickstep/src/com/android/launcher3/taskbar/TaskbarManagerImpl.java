...
public class TaskbarManagerImpl implements DisplayDecorationListener {
    ...
    private static final Uri NAVIGATION_BAR_HINT_URI = Settings.Secure.getUriFor(
    ...
    public TaskbarManagerImpl(
        ...
        SettingsCache.INSTANCE.get(mPrimaryWindowContext)
                .register(NAVIGATION_BAR_HINT_URI, mOnSettingsChangeListener);
    ...
    public void destroy() {
        ...
        SettingsCache.INSTANCE.get(mPrimaryWindowContext)
                .unregister(NAVIGATION_BAR_HINT_URI, mOnSettingsChangeListener);
        if (DesktopExperienceFlags.ENABLE_SYS_DECORS_CALLBACKS_VIA_WM.isTrue()
                && DesktopExperienceFlags.ENABLE_DISPLAY_CONTENT_MODE_MANAGEMENT.isTrue()) {
